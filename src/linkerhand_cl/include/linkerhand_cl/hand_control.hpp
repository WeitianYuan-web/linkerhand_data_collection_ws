...
#ifndef LINKERHAND_CL_HAND_CONTROL_HPP_
#define LINKERHAND_CL_HAND_CONTROL_HPP_
 ...
 * @brief CAN 协议帧属性
 */
enum class HandFrameType : uint8_t
{
    /* 有返回类型 (Return) */
    JOINT_PITCH_R = 0x01,      /* 俯仰角-手指根部弯曲 */
    JOINT_YAW_R = 0x02,         /* 横摆角-手指横摆 */
    JOINT_ROLL_R = 0x03,        /* 横滚角-大拇指专用 */
    JOINT_TIP_R = 0x04,         /* 指尖角度控制 */
    JOINT_SPEED_R = 0x05,       /* 电机运行速度 */
    JOINT_CURRENT_R = 0x06,     /* 电机运行电流 */
    JOINT_FAULT_R = 0x07,       /* 电机故障状态 */
    
    REQUEST_DATA_RETURN = 0x09, /* 请求数据返回 */
    ...
    JOINT_TIP_NR = 0x14,
    JOINT_SPEED_NR = 0x15,
    JOINT_CURRENT_NR = 0x16,
    JOINT_FAULT_NR = 0x17,
    
    WHOLE_FRAME = 0x21,         /* 整帧传输 */
    INVALID_FRAME = 0x00        /* 无效帧 */
};
...
#endif  // LINKERHAND_CL_HAND_CONTROL_HPP_
